"""Generate the isolated dynamic-N VoxelUnique correctness ONNX."""
...
def main() -> int:
    ...
    graph = helper.make_graph(
        ...
        [
            ...
            helper.make_tensor_value_info(
                "unique_values", TensorProto.INT64, ["M"]
            ),
            helper.make_tensor_value_info(
                "inverse_indices", TensorProto.INT64, ["N"]
            ),
        ],
    )
    ...
    print("DYNAMIC_CUSTOM_ONNX_GENERATION_PASSED")
    return 0
